...
class TestEnsureConsulDependencies(TestCase):
    ...
    def test_ensure_consul_dependencies_raises_error_when_the_first_command_fails(self):
    ...
    def test_ensure_consul_dependencies_raises_error_when_the_second_command_fails(self):
