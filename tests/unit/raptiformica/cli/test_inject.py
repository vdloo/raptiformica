...
class TestInject(TestCase):
    def setUp(self):
        self.parse_inject_arguments = self.set_up_patch('raptiformica.cli.parse_inject_arguments')
        self.update_meshnet_config = self.set_up_patch('raptiformica.cli.update_meshnet_config')
