from raptiformica.actions.mesh import get_consul_password
from tests.testcase import TestCase


class TestGetConsulPassword(TestCase):
    def setUp(self):
        self.mapping = {
    ...
    def test_get_consul_password_gets_consul_password(self):
        ret = get_consul_password(self.mapping)
        self.assertEqual(ret, 'a_different_secret')
